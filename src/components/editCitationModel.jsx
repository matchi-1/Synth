...
const EditCitationModal = ({ show, onClose, citation, setCitation }) => {
  ...
  // Save changes
  const handleSave = () => {
    // Filter out authors with no names in any field
    ...
    setCitation({
      ...
      datePublished,
      dateAccessed,
      authors: filteredAuthors, // Use the filtered authors list
      url,
    });
